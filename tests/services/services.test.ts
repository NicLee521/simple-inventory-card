  ...
  describe('addItem', () => {
    ...
    it('should successfully add item with all data', async () => {
      ...
      expect(mockHass.callService).toHaveBeenCalledWith(DOMAIN, SERVICES.ADD_ITEM, {
        ...
        [PARAMS.SERVING_SIZE]: DEFAULTS.SERVING_SIZE,
        [PARAMS.SERVINGS_PER_UNIT]: DEFAULTS.SERVINGS_PER_UNIT,
        [PARAMS.CALORIES_PER_SERVING]: DEFAULTS.CALORIES_PER_SERVING,
        [PARAMS.PROTEIN_PER_SERVING]: DEFAULTS.PROTEIN_PER_SERVING,
        [PARAMS.CARBOHYDRATES_PER_SERVING]: DEFAULTS.CARBOHYDRATES_PER_SERVING,
        [PARAMS.FAT_PER_SERVING]: DEFAULTS.FAT_PER_SERVING,
